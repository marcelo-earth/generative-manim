...
| [Training Dataset Format](./training-dataset-format.md) | JSONL schemas for each stage of the training pipeline: raw prompts, teacher completions, validated completions, and SFT train/val/test splits. |
